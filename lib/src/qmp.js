...
(function() {
  ...
  class Qmp {
    constructor() {
      this.vmName = vmName;
      this.usb_bus = usb_bus != null ? usb_bus : "usb-bus.0";
      this.socket = void 0;
      this.port = void 0;
      this.dataCb = void 0;
      this.close = false;
    ...
    connect(port, cb) {
      ...
      return setTimeout(() => {
        ...
        this.socket.on('data', (data) => {
          var callback, e, event, json, jsons, parsedData, _i, _len, _ref, _ref1, _ref2, _results;
        ...
        return this.socket.on('error', (e) => {
          if (e.message === 'This socket has been ended by the other party') {
            return console.log('QEMU closed connection');
